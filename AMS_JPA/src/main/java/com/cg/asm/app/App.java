...
public class App {
	...
	public static void main(String[] args) {
		...
		jump2: while (true) {
			...
			System.out.println("Enter Your Choice That You Wish");
...

			{
				...
				jump1: while (true) {
					...
					case 1:
						...
						emp.setEname(name);
						System.out.println("Enter DepartmenttId Of The Employee");
						...
						System.out.println("Added Employee :" + service.addEmployeeService(emp));
						break;
					case 2:
				...
				jump: while (true) {
					...
					case 3:
						System.out.println("Enter The Asset Id You That Want To Update");
					...
					case 5:
						...
						break;
					case 6:
						System.out.println("Enter Allocation Id To Set The Status");
						...
						if (service.setStatusService(allocation_id, assetstatus)) {
							...
							System.out.println("Status Not Changed Becos Of Invalid Allocation Id");
						}
						break;
					...
					case 7:
						...
						break jump;
					default:
						System.out.println("Enter Valid umber");
						break;
					}
				}
			} else if (id == 3) {
